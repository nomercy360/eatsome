...
const file = readdirSync(dir).filter((f) => f.includes("meal-v14")).sort().at(-1) as string;
...
console.log("| model | pass | recall | structure | dishes reported/expected | counts | panel errors |");
console.log("| --- | --- | --- | --- | --- | --- | --- |");
