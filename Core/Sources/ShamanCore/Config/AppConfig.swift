...
public struct AppConfig: Codable, Sendable {
    ...
    /// in front of the group table.
    ///
    /// Absent means the protein group table alone and no other figure at all,
    /// which is what every build before this shipped with — so a config that has
    /// never heard of this field behaves exactly as it did. Generated by
