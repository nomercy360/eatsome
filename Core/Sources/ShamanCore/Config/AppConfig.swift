...
public struct AppConfig: Codable, Sendable {
    ...
    /// Retired kind-level protein compatibility slot. New nutrition uses the
    /// exact food table and leaves a miss unresolved.
    ...
    /// Protein, fat, carbohydrate, energy and sodium per 100 g for named foods,
    /// with optional, explicitly selected broad-kind representatives.
    ///
    /// Absent means no food can resolve to derived nutrition. Generated by
    /// `scripts/build-food-table.py`; never hand-edited, because a figure with
