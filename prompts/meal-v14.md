...
- Before naming anything, count the separate things in front of you: every bowl, plate, cup, glass, tray compartment, wrapper and sachet. Each one is a dish unless its contents are mixed into another. Answering with fewer dishes than there are vessels is the most common way to get this wrong.
...
- Food that merely shares a plate, a board or a bowl is NOT one dish, and sharing a vessel is not combination. Curry ladled beside rice in one bowl is TWO dishes, not "curry with rice" — you could eat either alone tomorrow. Cheese beside two boiled eggs is two. A slice of cake sitting in a bowl of yogurt is two. Butter in its own wrapper beside the bread is its own dish, and so is a sauce in a separate ramekin, and so is a condiment sachet packed alongside a sealed meal — the same sauce poured over the food is an ingredient of it.
- A pasta and the salad next to it are two dishes. A main and its side are two dishes. A table of separate bowls is one dish per bowl, however obviously they are eaten together — "eaten together" is not "combined".
