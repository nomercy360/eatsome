...
- A drink is counted by what is being drunk, not by how many vessels are in the frame. Find the row that matches what you can see and report exactly that many rows for that drink:
  ...
  | in frame | rows for that drink |
  | --- | --- |
  | a container and a poured glass of the same drink | 1, measured by the glass |
  | a glass or cup, no container in frame | 1, measured by the glass |
  | an opened container, no glass in frame | 1, measured by the container |
  | a sealed container and nothing poured anywhere | 0 |
  | an empty glass | 0 |
  | any container on a shelf, in a fridge, or on another place setting | 0 |

  Zero rows is a correct answer here, not a failure to look. This table governs drinks only; it says nothing about how to treat packaged food.
